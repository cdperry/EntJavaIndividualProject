...
public class GrainAddEditDisplayServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("action").equals("insert")) {
            ...
            componentId = Integer.parseInt(request.getParameter("grainId"));
            // TODO: Change this to getComponentEntityByType and give it the 'grain' type
            component = componentDao.getComponentEntity(componentId);
            if (component != null) {
                request.setAttribute("grain", component);
