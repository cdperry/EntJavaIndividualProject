...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Add/Edit Supplier Type</h1>
    </div>
</div>
    ...
    <div class="col-lg-12">
        ...
        <form class="form-horizontal" method="POST" action='/doEditSupplierType' name="frmAddSupplierType">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" readonly="readonly" id="supplierTypeId"
                           name="supplierTypeId"
                           value="<c:out value="${supplierType.supplierTypeId}" />" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name"
                           value="<c:out value="${supplierType.name}" />" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-offset-2 col-sm-10">
                    <c:choose>
                        <c:when test="${actionType == 'edit'}">
                            <c:set var="buttonText" scope="request" value="Update Supplier Type"/>
                        </c:when>
                        <c:otherwise>
                            <c:set var="buttonText" scope="request" value="Add Supplier Type"/>
                        </c:otherwise>
                    </c:choose>
