...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Add/Edit Use Type</h1>
    </div>
</div>
    ...
    <div class="col-lg-12">
        ...
        <form class="form-horizontal" method="POST" action='/doEditUseType' name="frmAddUseType">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" readonly="readonly" id="useTypeId"
                           name="useTypeId"
                           value="<c:out value="${useType.useTypeId}" />" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name"
                           value="<c:out value="${useType.name}" />" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-offset-2 col-sm-10">
                    <c:choose>
                        <c:when test="${actionType == 'edit'}">
                            <c:set var="buttonText" scope="request" value="Update Use Type"/>
                        </c:when>
                        <c:otherwise>
                            <c:set var="buttonText" scope="request" value="Add Use Type"/>
                        </c:otherwise>
                    </c:choose>
