...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Add/Edit Yeast Type</h1>
    </div>
</div>
    ...
    <div class="col-lg-12">
        ...
        <form class="form-horizontal" method="POST" action='/doEditYeastType' name="frmAddYeastType">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" readonly="readonly" id="yeastTypeId"
                           name="yeastTypeId"
                           value="<c:out value="${yeastType.yeastTypeId}" />" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name"
                           value="<c:out value="${yeastType.name}" />" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-offset-2 col-sm-10">
                    <c:choose>
                        <c:when test="${actionType == 'edit'}">
                            <c:set var="buttonText" scope="request" value="Update Yeast Type"/>
                        </c:when>
                        <c:otherwise>
                            <c:set var="buttonText" scope="request" value="Add Yeast Type"/>
                        </c:otherwise>
                    </c:choose>
