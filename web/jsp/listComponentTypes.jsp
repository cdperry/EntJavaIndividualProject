    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <c:import url="components/component-type-body.jsp" />
        ...
        <script>
            $('#myModal').on('show.bs.modal', function (event) {
                ...
                <%--$("#confirmedDelete").attr('href', '/deleteComponentType?componentTypeId=' + id)--%>
                $("#frmConfirmDelete").attr("action", "deleteComponentType?componentTypeId=" + id)
            })
        </script>
